/**
 * IrmsWebServicesSoapBindingStub.java
 *
...
public class IrmsWebServicesSoapBindingStub extends org.apache.axis.client.Stub implements localhost.wf_pon.services.IrmsWebServices.IrmsWebServices {
    ...
    public IrmsWebServicesSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public IrmsWebServicesSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public IrmsWebServicesSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public java.lang.String createProject(java.lang.String xml) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://webservice.workflow.boco.com", "createProject"));
